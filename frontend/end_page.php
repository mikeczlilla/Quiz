...
<body>
    <img style="width: 100px; position: absolute; top: 30px; left: 30px; border-radius: 10px;" src="kep/quiz.logo.png" alt="logo">
    <div class="card">
        <div class="card-body text-center">
            <h2>Kvíz vége!</h2>
            <p>Elért pontszám: <?php echo $_SESSION['score']; ?> / <?php echo $_SESSION['totalQuestions']; ?></p>
