...
if (!isset($_SESSION['quiz_questions1'])) {

  $sql = "SELECT id, kerdes, jo_valasz, rossz_valasz1, rossz_valasz2, rossz_valasz3 
            FROM kerdesek1 
            ORDER BY RAND()";
  ...
  $_SESSION['quiz_questions1'] = $questions;
  $_SESSION['current_index1'] = 0;
  $_SESSION['score1'] = 0;
  $_SESSION['quiz_finished1'] = false;
}

if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$_SESSION['quiz_finished1']) {
  $currentIndex = $_SESSION['current_index1'];
  $questions = $_SESSION['quiz_questions1'];
  ...
  if (isset($questions[$currentIndex])) {
    ...
    $_SESSION['current_index1']++;

    if ($_SESSION['current_index1'] >= count($questions)) {
      $_SESSION['quiz_finished1'] = true;
    }
  }
...
$currentIndex = $_SESSION['current_index1'];
$questions = $_SESSION['quiz_questions1'];
$finished = $_SESSION['quiz_finished1'];
