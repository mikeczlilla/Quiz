...
if (!isset($_SESSION['quiz_questions2'])) {

  $sql = "SELECT id, kerdes, jo_valasz, rossz_valasz 
            FROM kerdesek2 
            ORDER BY RAND()";
  ...
  $_SESSION['quiz_questions2'] = $questions;
  $_SESSION['current_index2'] = 0;
  $_SESSION['score2'] = 0;
  $_SESSION['quiz_finished2'] = false;
}

if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$_SESSION['quiz_finished2']) {
  $currentIndex = $_SESSION['current_index2'];
  $questions = $_SESSION['quiz_questions2'];
  ...
  if (isset($questions[$currentIndex])) {
    ...
    $_SESSION['current_index2']++;

    if ($_SESSION['current_index2'] >= count($questions)) {
      $_SESSION['quiz_finished2'] = true;
    }
  }
...
$currentIndex = $_SESSION['current_index2'];
$questions = $_SESSION['quiz_questions2'];
$finished = $_SESSION['quiz_finished2'];
